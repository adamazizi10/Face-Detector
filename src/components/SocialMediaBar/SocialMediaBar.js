    ...
    return (
        ...
        <div className="mf-social-side-list">
            <ul className="socialul">
                ...
                <li className="eaachSocialul">
                    <a href="https://github.com/adamazizi10" rel="noreferrer" target="_blank">
                        <i className='githubSpecific'><FaGithub color={'white'} size={'2.2rem'} style={{marginBottom: '22px'}}/></i>
                    </a>
                </li>
                <li className="eaachSocialul">
                    <a href="https://www.youtube.com/channel/UCynnrKNESe3gktlbUoLayHQ" rel="noreferrer" target="_blank">
